...
function insertSimulation2() {
    ...
    appStr = "<br /><br /><applet archive=\"" + p + "/" + document.getElementById("appArchive").value + "\" code=\"" + document.getElementById("appCode").value + "\" width=\"" + document.getElementById("appWidth").value + "\" height=\"" + document.getElementById("appHeight").value + "\"> <b>Java must be enabled to run this simulation</b>."
